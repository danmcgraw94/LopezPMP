...
The procedures in Hydrometeorological Report No. 36 (MHR 36) were used to estimate the PMP for Lopez Dam. The calculation was done in R and is recreated in this section. The index maps in the HMR 36 PDF are scanned pages. Additionally, corresponding GIS files could not be found at this time.
...
## Section 9.03 - Determine Convergence PMP
...
1.  Determine average probable maximum convergence precipitation index withinbasin outline from figure 4-12 (grid average is adequate).
